...
import EducationCard from '../Search/EducationCard';
...
const EducationPage = () => {
  ...
  useEffect(() => {
    dispatch(fetchPodcasts('Education'))
  }, [dispatch]);
    ...
    <div style={{ paddingLeft: "20px", paddingTop: "5px" }}>
      ...
      {loading ? (
        ...
        <Box sx={{ padding: "20px", height: "500px", maxHeight: "1200px", overflowY: "auto" }}>  
          <EducationCard podcasts={podcasts} loading={loading} />
        </Box>
      )}
