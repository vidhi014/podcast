...
import MostPopularCard from '../Search/MostPopularCard';
import { CircularProgress, Box, Button, Dialog, DialogTitle, DialogContent, TextField, DialogActions, Typography } from '@mui/material';
...
const dispatch = useDispatch();
  ...
  useEffect(() => {
    dispatch(fetchPodcasts('Most Popular'))
  }, [dispatch]);
    ...
    <div style={{ paddingLeft: "20px", paddingTop: "5px" }}>
      ...
      {loading ? (
        ...
        <Box sx={{ padding: "20px", height: "500px", maxHeight: "1200px", overflowY: "auto" }}>  
          <MostPopularCard podcasts={podcasts} loading={loading} />
        </Box>
      )}
